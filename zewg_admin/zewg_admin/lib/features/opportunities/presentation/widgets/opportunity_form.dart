...
import '../../../../core/utils/cover_image_util.dart';
...
class _OpportunityFormState extends State<OpportunityForm> {
  ...
  void initState() {
    ...
    _compensationAmtCtrl = TextEditingController(text: e?.compensationAmount ?? '');
    ...
    _compensation = _normalizeCompensation(e?.compensation ?? 'Paid');
  ...
  String _normalizeCompensation(String value) {
  ...
  Future<void> _pickCoverImage() async {
    ...
    if (file == null) return;
    final encoded = await CoverImageUtil.encodePickedImage(file);
    if (encoded != null) {
      setState(() => _coverImagePath = encoded);
    }
  }
    ...
    return Column(
      ...
      children: [
        if (_isEditMode)
          _sectionCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(hintText: 'e.g. Senior Research Fellow'),
              ),
            ]),
          )
        else ...[
          const Text(
            'Curate Excellence',
            style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: ZewgTheme.textPrimary),
          ),
          const SizedBox(height: 8),
          const Text(
            'Create a new entry for the global student community. Your precision helps shape professional futures.',
            style: TextStyle(fontSize: 14, color: ZewgTheme.textSecondary, height: 1.5),
          ),
          const SizedBox(height: 24),
          const FieldLabel(text: 'Opportunity Title'),
          TextField(
            controller: _titleCtrl,
            decoration: const InputDecoration(hintText: 'e.g. Senior Research Fellowship 2024'),
          ),
        ],
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 15,
                      color: _deadline != null ? ZewgTheme.textPrimary : ZewgTheme.textMuted,
                    ),
                  ),
                ),
                const Icon(Icons.calendar_today_outlined, size: 18, color: ZewgTheme.textSecondary),
              ],
            ),
          ),
        ),
        ...
        _sectionCard(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            ZewgDropdown(
              ...
              onChanged: (v) {
                if (v != null) setState(() => _compensation = v);
              },
            ),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                prefixIcon: Icon(Icons.attach_money, size: 18, color: ZewgTheme.textSecondary),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                prefixIcon: Icon(Icons.location_on_outlined, size: 18, color: ZewgTheme.textSecondary),
        ...
        _sectionCard(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const Text('Education',
                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: ZewgTheme.textPrimary)),
            const SizedBox(height: 8),
            TextField(
              controller: _educationCtrl,
              maxLines: 3,
              decoration: const InputDecoration(hintText: 'Degree, major, or specific academic standing...'),
            ),
            const SizedBox(height: 16),
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: const InputDecoration(hintText: 'Years of experience, specific industry roles...'),
            ),
            const SizedBox(height: 16),
            const Text('Skills',
                style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: ZewgTheme.textPrimary)),
            ...
            if (_isEditMode && _skillsCtrl.text.isNotEmpty)
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Text(
                        '+ Edit Skills',
                        style: TextStyle(fontSize: 12, color: ZewgTheme.primary, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ),
                ],
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Technical proficiencies, soft skills, or certifications...',
                ),
              ),
          ]),
        ),
        ...
        TextField(
          ...
          maxLines: 6,
          decoration: const InputDecoration(
            hintText: 'Describe the benefits and expectations of this opportunity...',
          ),
        ),
        const SizedBox(height: 24),
        _sectionCard(
              ...
              return Padding(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(color: ZewgTheme.primary, shape: BoxShape.circle),
                    child: Center(
                      child: Text('${i + 1}',
                    ...
                    child: Column(children: [
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Step Title (e.g. ${i < hints.length ? hints[i] : "Next Step"})',
                        ),
                      ),
                      const SizedBox(height: 8),
                      TextField(
                        ...
                        maxLines: 2,
                        decoration: const InputDecoration(hintText: 'Brief description of this phase...'),
                      ),
                    ]),
                  ),
                  if (_steps.length > 1)
                    IconButton(
                      ...
                      icon: const Icon(Icons.close, size: 18, color: ZewgTheme.textMuted),
                    ),
                ]),
              );
            }),
        ...
        TextField(
          ...
          decoration: const InputDecoration(
            prefixIcon: Icon(Icons.link, size: 18, color: ZewgTheme.textSecondary),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              const Icon(Icons.add_photo_alternate_outlined, size: 36, color: ZewgTheme.textSecondary),
              const SizedBox(height: 8),
              Text(
                _isEditMode ? 'Change cover photo' : 'Upload Cover Image',
                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: ZewgTheme.textPrimary),
              ),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(_isEditMode ? Icons.check_circle_outline : Icons.send_outlined, size: 18),
            ]),
          ),
        ),
        if (_isEditMode && widget.onDelete != null) ...[
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.delete_outline, size: 18, color: ZewgTheme.danger),
              label: const Text('Delete Post',
                  style: TextStyle(color: ZewgTheme.danger, fontWeight: FontWeight.w600)),
          ...
          Center(
            child: Text(
              ...
              style: const TextStyle(fontSize: 11, color: ZewgTheme.textMuted, height: 1.6),
            ),
          ),
        ] else ...[
          const SizedBox(height: 12),
          const Center(
            child: Text(
              ...
              style: TextStyle(fontSize: 11, color: ZewgTheme.textMuted, letterSpacing: 0.5),
            ),
          ),
        ],
        const SizedBox(height: 32),
  ...
  Widget _sectionHeader(String title, IconData icon) {
    return Row(children: [
      ...
      const SizedBox(width: 8),
      Text(title,
          style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: ZewgTheme.textPrimary)),
    ]);
  }
    ...
    showDialog(
      ...
      builder: (ctx) {
        ...
        return AlertDialog(
          ...
          title: const Text('Edit Skills', style: TextStyle(fontWeight: FontWeight.w700)),
          content: TextField(
            controller: ctrl,
            decoration: const InputDecoration(hintText: 'Comma-separated skills'),
          ),
          actions: [
